...
// new Swiper(선택자, 옵션)
new Swiper('.notice-line .swiper-containter', {
    direction: 'vertical',
    autoplay: true,
    loop: true
});
new Swiper('.promotion .swiper-containter', {
...
const promitionToggleEl = document.querySelector('.toggle-promotion');
let isHidePromotion = false;
promitionToggleEl.addEventListener('click', function() {
